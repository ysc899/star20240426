package kr.co.seesoft.nemo.starnemo.service;
...
public class LocationUpdatesService extends Service {
    ...
    private static final String PACKAGE_NAME =
            "kr.co.seesoft.nemo.starnemo.service";
...
//        Log.i(TAG, "New location: " + location);
        AndroidUtil.log("New location: " + location);

        LocationVO t = new LocationVO();
        t.date = new Date();
        t.latitude = location.getLatitude();
        t.longitude = location.getLongitude();

        nemoRepository.insert(t);
