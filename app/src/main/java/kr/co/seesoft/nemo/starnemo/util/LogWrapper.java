...
public class LogWrapper {
    ...
    static {
        try{
            ...
            File f = new File(Environment.getExternalStorageDirectory()+ File.separator + "Android"+File.separator+"data"+ File.separator +"kr.co.seesoft.nemo.starnemo"+ File.separator +"log");
            if(!f.exists()){
                f.mkdirs();
            }
