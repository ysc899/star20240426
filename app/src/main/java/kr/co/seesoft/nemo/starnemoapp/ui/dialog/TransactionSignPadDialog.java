...
public class TransactionSignPadDialog extends Dialog {
    ...
    public TransactionSignPadDialog(Context context, Handler handler){
        super(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_transaction_sign_pad);
        initUI();
        init();
    }
