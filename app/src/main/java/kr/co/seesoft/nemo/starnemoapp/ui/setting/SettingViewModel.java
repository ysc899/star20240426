...
import kr.co.seesoft.nemo.starnemoapp.logapi.service.LogCollectorAPI;
    ...
    public void collectLogDatas(){
        ...
        executorService.execute(()->{
            ...
            try {
                ...
                File logDir = new File(Environment.getExternalStorageDirectory()+ File.separator + "Android"+File.separator+"data"+ File.separator +"kr.co.seesoft.nemo.starnemoapp"+ File.separator +"log");
