...
public class LogWrapper {
    ...
    private static final String LOG_FILE_NAME = "star_nemo_Log_%g.txt";
    ...
    static {
        try{
            ...
            File f = new File(Environment.getExternalStorageDirectory()+ File.separator + "Android"+File.separator+"data"+ File.separator +"kr.co.seesoft.nemo.starnemoapp"+ File.separator +"log");
            if(!f.exists()){
                f.mkdirs();
            }
